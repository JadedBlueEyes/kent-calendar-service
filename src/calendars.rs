...
use crate::{kent_schema, sums_pluto_schema};

pub(crate) async fn sums_calendar<T: Fn(&sums_pluto_schema::Event) -> String>(
    site_id: &str,
    title: &str,
    description: &str,
    url_formatter: T,
...
pub(crate) async fn kent_calendar(url: &str) -> Result<Calendar, anyhow::Error> {
